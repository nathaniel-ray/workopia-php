...
class ListingController
{
    ...
    public function store()
    {
        ...
        $newListingData['user_id'] = Session::get('user')['id']; // get the user id from session
        ...
        if (!empty($errors)) {
            ...
            // tags,company,adress,city,state,phone,email,requirements,benefits,user_id)
            // VALUES(:title,:description,:salary,:tags,:company,:address,:city,:state,
            // :phone,:email,:requirements,:benefits,:user_id)', $newListingData);
